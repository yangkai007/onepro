<template>
  <div class="ratings" ref="ratings">
    <link rel="stylesheet" href="at.alicdn.com/t/font_2085738_buig8tqdqs.css" />
      ...
      <div class="overview">
        ...
        <div class="overview-right">
          <div class="score-wrapper">
            ...
            <Starxx :rating="info.serviceScore" :size="48" />
            <span class="score">{{ info.serviceScore }}</span>
          </div>
          <div class="score-wrapper">
            <span class="title">商品评分</span>
            <Starxx :rating="info.foodScore" :size="36" />
          ...
          >
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                <Starxx :rating="rating.score" :size="24" />
              ...
              <div class="recommend">
                <span
                  class="iconfont"
                  :class="
                    rating.rateType === 0 ? 'icon-good_filled' : 'icon-_cai'
                  "
                ></span>
                <span
                  class="item"
